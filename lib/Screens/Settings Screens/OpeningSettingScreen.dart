...
class _OpeningSettingScreenState extends State<OpeningSettingScreen> {
  ...
  final Uri uri = Uri.parse('https://app.termly.io/document/privacy-policy/9f2498be-c08d-48dc-bca4-e45466e50191');

  final Uri disclaimerUri = Uri.parse('https://app.termly.io/document/disclaimer/4348799a-cbfa-45fc-a387-62a4a1c04af0');

  final Uri returnPolicyUri = Uri.parse('https://app.termly.io/document/refund-policy/a898715e-31ff-4903-ad9f-d8cf5f991844');
  setUp() async{
  ...
  SafeArea CITexQuote(BuildContext context) {
    ...
    return SafeArea(child: Column(
      children: [
        Center(child: Container(height:150,child: Image.asset('lib/Images/Top Tier Logos/TopTierLogo_TRNS.png'))),

        Text('Version: ${constantDatabase.version}', style: Theme
            .of(context)
            .textTheme
            .bodySmall!
            .copyWith(color: Theme
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Text('Address', style: TextStyle(color: Theme
                  .of(context)
                  .colorScheme
                  .primary),),

              IconButton(onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>AddressSettingsScreen(client: widget.client,)));
              },
                  icon: Icon(Icons.arrow_forward_ios_outlined, color: Theme
                      .of(context)
                      .colorScheme
          ...
          Row(
            ...
            children: [
              Text('All Orders', style: TextStyle(color: Theme
                  .of(context)
                  .colorScheme
                  .primary),),
          ...
          Row(
            ...
            children: [
              Text('Past Orders', style: TextStyle(color: Theme
                  .of(context)
                  .colorScheme
                  .primary),),

              IconButton(onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>PreviousOrdersScreen(client: widget.client,)));
              },
                  icon: Icon(Icons.arrow_forward_ios_outlined, color: Theme
                      .of(context)
                      .colorScheme
          ...
          Row(
            ...
            children: [
              Text('Return Policy', style: TextStyle(color: Theme
                  .of(context)
                  .colorScheme
                  .primary),),
          ...
          Row(
            ...
            children: [
              Text('Disclaimer', style: TextStyle(color: Theme
                  .of(context)
                  .colorScheme
                  .primary),),
